...
public class GuideActivity extends Activity {
	...
	private void initListener() {
		...
		iv_point_red.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			@SuppressWarnings("deprecation")
			@Override
			public void onGlobalLayout() {
				iv_point_red.getViewTreeObserver().removeGlobalOnLayoutListener(this);//避免重复回调
				mPointDis=llParent.getChildAt(1).getLeft()-llParent.getChildAt(0).getLeft();
			}
		});
		/**
		 * 点击跳转到主页面
		...
		btn_start.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				PerfUtils.setBoolean(getApplicationContext(), "loginState", false);
