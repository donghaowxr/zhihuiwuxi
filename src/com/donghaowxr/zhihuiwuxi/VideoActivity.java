...
public class VideoActivity extends Activity implements OnClickListener {
	...
	private void initView() {
		...
		llDanmuAdd = (LinearLayout) findViewById(R.id.ll_danmu_add);
		btnSendDanmu = (Button) findViewById(R.id.btn_send_danmu);
		mDanmakuView = (DanmakuView) findViewById(R.id.sv_danmaku);
		etSendDanmu = (EditText) findViewById(R.id.et_send_danmu);
